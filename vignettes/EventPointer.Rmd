...
![Figure 1. General worflow EventPointerToolkit](Fig1_vignnete_EP.png)
...
![Figure 4. Splicing graph](SplicingGraph.png)
...
El formato de salida de la tabla de eventos resultante de la funcion EventPointerStats_ST() es similar a la de su función homóloga de EventPointerBAM. El aspecto de la carpeta que contiene el resultado del flujo de trabajo completo es el siguiente: 
![Figure 5. Output EventPointerBAM functions](archivosEPST.drawio.png)
